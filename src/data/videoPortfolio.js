...
export const FEATURED_REEL = [
  {
    ...
    category: '',
    description: 'Curated collection of AI-generated visual content.',
    variant: 'reels',
    reels: [
      {
        id: 'reel-06-01',
        ...
        mobileVideo: reelAsset('mobile', '3rd-card/video1-optimized.mp4'),
      },
      {
        id: 'reel-06-02',
        title: 'Jewellery Ad',
        ...
        mobileVideo: reelAsset('mobile', '3rd-card/video2-optimized.mp4'),
      },
      {
        id: 'reel-06-03',
        title: 'Jewellery Ad',
        ...
        mobileVideo: reelAsset('mobile', '3rd-card/video3-optimized.mp4'),
      },
      {
        id: 'reel-06-04',
        title: 'Jewellery Ad',
        ...
        mobileVideo: reelAsset('mobile', '3rd-card/video4-optimized.mp4'),
      },
      {
        id: 'reel-06-05',
        title: 'Jewellery Ad',
        ...
        mobileVideo: reelAsset('mobile', '3rd-card/video5-optimized.mp4'),
      },
    ],
  },
  {
